...
void HydroSourceTerms::AddSourceTerms(const Real time, const Real dt,
  ...
  // -------------------------------------
  // Add central point-mass gravity (custom)
  // -------------------------------------
/*
  {
    MeshBlock *pmb = pmy_hydro_->pmy_block;
    ...
    // GM を取得 (class mesh から取得)
    Real GM = pmb->pmy_mesh->GM;
    ...
    AddPointMassGravity(pmy_hydro_, pcoord, GM,
                        pmb->pmy_mesh->xstar,
                        pmb->pmy_mesh->ystar,
                        pmb->pmy_mesh->zstar,
                        ks, ke, js, je, is, ie);
